    ...
    .refine(
      (reports) => {
        ...
        for (const report of reports) {
          ...
          return true; // If all checks pass, the report is valid
        }
      },
      {
        message:
          "Each medical report must have either a valid reportId with shouldDelete set to true, or both reportName and reportLink provided.",
      },
    ),
});
